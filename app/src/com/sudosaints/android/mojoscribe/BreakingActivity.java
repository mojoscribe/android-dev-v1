...
public class BreakingActivity extends Activity {
	...
	private FetchNextPagePostsListener fetchNextPagePostsListener = new FetchNextPagePostsListener() {
		...
		public void fetchNextPagePosts() {
			...
			new DoPagination(BreakingActivity.this, idsCsv).execute();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		feedsListView.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				// TODO Auto-generated method stub
				new GetBreakingFeeds(BreakingActivity.this).execute();
				bIsPulled = true;
			}
		});
	...
	class GetBreakingFeeds extends AsyncTask<Void, Void, ApiResponse> {

		private Context context;
		private ProgressDialog progressDialog;

		public GetBreakingFeeds(Context context) {
			super();
		...
		protected ApiResponse doInBackground(Void... arg0) {
			...
			ApiResponse apiResponse = apiRequestHelper.doBreakingFeeds();
			return apiResponse;
		}
