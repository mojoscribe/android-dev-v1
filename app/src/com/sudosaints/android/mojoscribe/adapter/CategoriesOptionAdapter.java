...
import com.sudosaints.android.mojoscribe.CategoriesActivity;
...
public class CategoriesOptionAdapter extends BaseAdapter {
	...
	public CategoriesOptionAdapter(Context context, List<IdValue> options) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = li.inflate(R.layout.categories_row, parent, false);
		}
		...
		OnClickListener clickListener = new OnClickListener() {
			...
			public void onClick(View v) {
				Intent catgIntent = new Intent(context, CategoriesActivity.class);
				catgIntent.putExtra(IntentExtras.INTENT_CATEGORIES_ID, option.getId());
				((Activity) context).startActivity(catgIntent);
				((Activity) context).finish();
				// start activity n pass option.getId();
			}
		};
		TextView textView = (TextView) convertView.findViewById(R.id.categoryTextView);
		ImageButton button = (ImageButton) convertView.findViewById(R.id.categoryImageButton);
