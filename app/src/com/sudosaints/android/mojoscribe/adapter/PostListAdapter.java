...
public class PostListAdapter extends BaseAdapter {
	...
	public PostListAdapter(Context context, List<Feed> feeds, FetchNextPagePostsListener fetchNextPagePostsListener) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = li.inflate(R.layout.feed_single_item, parent, false);
		...
		feedOwnerImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if (feeds.get(position).getAuthorId() == 0) {
					Toast.makeText(context, "Anonymous post", Toast.LENGTH_LONG).show();
				} else {
