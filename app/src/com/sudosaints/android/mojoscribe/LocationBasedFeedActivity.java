...
public class LocationBasedFeedActivity extends  Activity {
	...
	private FetchNextPagePostsListener fetchNextPagePostsListener = new FetchNextPagePostsListener() {
		...
		public void fetchNextPagePosts() {
			...
			new DoPagination(LocationBasedFeedActivity.this, idsCsv).execute();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		uiHelper.generateDrawers(onOptionSelected, drawerOptionAction.BREAKING, R.layout.activity_main);
		...
		feedsListView.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				// TODO Auto-generated method stub
				new GetLocationFeeds(LocationBasedFeedActivity.this).execute();
				bIsPulled = true;
			}
		});
	...
	class GetLocationFeeds extends AsyncTask<Void, Void, ApiResponse> {

		private Context context;
		private ProgressDialog progressDialog;

		public GetLocationFeeds(Context context) {
			super();
		...
		protected ApiResponse doInBackground(Void... arg0) {
			...
			ApiResponse apiResponse = apiRequestHelper.doLocationBasedFeeds();
			return apiResponse;
		}
	...
	class DoPagination extends AsyncTask<Void, Void, ApiResponse> {
		...
		protected ApiResponse doInBackground(Void... arg0) {
			// TODO Auto-generated method stub
			ApiRequestHelper apiRequestHelper = new ApiRequestHelper(context);
			ApiResponse apiResponse = apiRequestHelper.doLocationBasedPagination(idsCSV);
			return apiResponse;
		}
